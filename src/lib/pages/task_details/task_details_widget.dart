...
class _TaskDetailsWidgetState extends State<TaskDetailsWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<TasksRecord>(
      stream: TasksRecord.getDocument(widget.toDoNote!),
            ...
            appBar: AppBar(
              ...
              actions: [
                        ...
                        return GestureDetector(
                          ...
                          child: Padding(
                            ...
                            child: CreateTaskEditWidget(
                              todoRef: taskDetailsTasksRecord,
                            ),
                          ),
                        );
                      },
                ...
                FlutterFlowIconButton(
                  ...
                  showLoadingIndicator: true,
                  onPressed: () async {
                    logFirebaseEvent('TASK_DETAILS_delete_rounded_ICN_ON_TAP');
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          taskDetailsTasksRecord.description,
                                          style: FlutterFlowTheme.of(context)
                                              .titleSmall
                                              .override(
                                                fontFamily:
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        dateTimeFormat(
                                          'MMMEd',
                                          taskDetailsTasksRecord.toFinishTime!,
                                ...
                                if (!taskDetailsTasksRecord.taskCompleted)
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 0.0, 24.0),
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'TASK_DETAILS_MARQUER_COMME_TERMINÉ_BTN_O');
                                        logFirebaseEvent('Button_backend_call');

                                        await taskDetailsTasksRecord.reference
