        ...
        FFRoute(
          ...
          builder: (context, params) => TaskDetailsWidget(
            toDoNote: params.getParam(
                'toDoNote', ParamType.DocumentReference, false, ['tasks']),
          ),
        ),
        FFRoute(
          name: 'MyProfile',
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/DALLE_2023-11-27_08.49.04_-_Create_a_single_logo_for_the_app_PlanParfait_in_Fluent_Design_style,_incorporating_a_kind_of_mica_effect._The_logo_should_be_minimalistic_yet_elegan.png',
