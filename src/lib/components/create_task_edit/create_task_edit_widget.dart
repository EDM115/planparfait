...
class _CreateTaskEditWidgetState extends State<CreateTaskEditWidget> {
  ...
  void initState() {
    ...
    _model.textController1 ??=
        TextEditingController(text: widget.todoRef?.taskName);
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.textController2 ??=
        TextEditingController(text: widget.todoRef?.description);
                          ...
                          child: Row(
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'CREATE_TASK_EDIT_COMP_ANNULER_BTN_ON_TAP');
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'CREATE_TASK_EDIT_COMP_ÉDITER_BTN_ON_TAP');
                                  ...
                                  await widget.todoRef!.reference
                                    ...
                                    toFinishTime: _model.datePicked,
                                  ));
